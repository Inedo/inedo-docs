...
[Repackaging](/support/documentation/proget/adavnced/repackaging) is a process of changing a package's version without changing its contents, enabling use-cases such as converting a pre-release package to a stable version, and more.
