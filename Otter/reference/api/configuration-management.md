...
#### Server Configuration Item Object {#server-configuration-item-object}
...
GET or POST ::/api/configuration/::{style="opacity: 0.5"}**remediate/status**?key=&laquo;api-key&raquo;&amp;token=&laquo;job-token&raquo; {.info}
