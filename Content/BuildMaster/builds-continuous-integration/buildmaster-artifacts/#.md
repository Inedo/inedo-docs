...
If you're not using script templates and you're writing your own script, you'll use the [Deploy Artifact](/docs/buildmaster-reference-operations-artifacts-deploy-artifact) operation for this. You can use it without any parameters but it's common to at least specify a target directory.
