...
When you run scripts this way, BuildMaster automatically replaces [variables](/buildmaster-variables) within the script. In the example above, `$ApplicationName` would be replaced with the name of the application being built or deployed.
