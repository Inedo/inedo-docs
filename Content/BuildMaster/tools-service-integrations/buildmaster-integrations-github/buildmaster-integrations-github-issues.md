...
You can then use `$GitHubIssueId` in later operations to automatically [change issue status](/docs/buildmaster/modeling-your-applications/buildmaster-applications-issue-tracking) or [add comments and notes](/docs/buildmaster-reference-operations-issue-tracking-add-comment-to-github-issue).
