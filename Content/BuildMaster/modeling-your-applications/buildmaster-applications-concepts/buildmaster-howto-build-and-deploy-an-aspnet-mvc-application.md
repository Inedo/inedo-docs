...
![Artifacts](/resources/docs/buildmaster/builds-continuous-integration/buildmaster-artifacts-list.png){height="" width="50%"}
...
You can also specify deployment options which are covered in more detail on our [Configuration Files](/docs/buildmaster/deployment-continuous-delivery/buildmaster-applications-configuration-files?#creating-an-application-configuration-file) page. For now though, select "Create Configuration File".
...
![Select Pipeline](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-select.png){height="" width="50%"}
...
![New Pipeline](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-new.png){height="" width="50%"}

![Create Pipeline](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-create.png){height="" width="50%"}
