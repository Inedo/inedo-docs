...
:::(Error) (Skip BuildMaster 6.2: Upgrade Directly to BuildMaster 2026)
If you are using BuildMaster 6.1, we recommend directly [Upgrading to BuildMaster 2026](/docs/buildmaster-upgrade-2026). If you using an earlier version, you will first need to [Upgrade to BuildMaster 6.1](/docs/buildmaster-upgrading-to-6-1).
:::
