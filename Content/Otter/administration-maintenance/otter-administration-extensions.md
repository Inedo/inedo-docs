...
- **Rich Descriptions** - the [Inedo.Documentation](/sdk/inedosdk/inedo.documentation?_ga=2.129019916.1811665350.1618188594-1045598186.1617146819){target="_blank"} components enable you to describe Operations in a plan using a consistent, visually-rich description so that anyone reading it will see, at-a-glance, what the operation is configured to do.
...
See the [Otter v1 SDK Reference](/sdk/otter?_ga=2.129019916.1811665350.1618188594-1045598186.1617146819){target="_blank"} for more information.
