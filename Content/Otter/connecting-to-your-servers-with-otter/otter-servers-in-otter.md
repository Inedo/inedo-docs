...
Otter can communicate with servers that have the [Inedo Agent](/inedoagent-overview) installed or use "agent-less" communication with PowerShell remoting (WMI) or with SSH. 
...
Once your server has been prepared, you can add the server by going to `Servers > Add Server`, or you can use the [infrastructure API](/otter-reference-api). 
...
To learn more see [Collecting Containers and Packages ](/otter-collecting-containers-and-packages) 
