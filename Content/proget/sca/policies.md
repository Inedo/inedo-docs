 ...
 * Every evening using the Package Analyzer [Scheduled Job](/proget-administration-service#scheduled-jobs)
...
ProGet includes a comprehensive database of open-source licenses and detection methods to help match packages to licenses. You can also add your license definitions; see [How does ProGet detect Licenses?](/proget-sca-licenses#how-does-proget-detect-licenses) to learn more.
:::
