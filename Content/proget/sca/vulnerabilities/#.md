...
#### Blocked Packages
:::(Internal) (TODO: Move to ProGet 2023 and before)
Blocked PAckages  will not be used/visible afte Projects/Policies, so move it
:::
...
:::(Info) (👨‍🔬 Note from Inedo's Engineers)
*Although ProGet 2024 has not yet been released, many of the capabilities planned for ProGet 2024 are available as preview features in ProGet 2023 maintenance releases. In an effort to keep our documentation as up-to-date as possible, we are updating the documentation in tandem with these feature previews and trying to use "past/present" tense to talk about ProGet 2024.*
:::
