...
:::(Internal) (Update Screenshot - this is now changed)
...
:::(Internal) (Add sentence/paragraph about limitations)
{quick sentence/para about limitations and link to guide}
:::
...
:::(Internal) (Add Screenshot)
Override a Contain to a Remediate with a comment "this library is only ever used to parse trusted input, so there's no risk here".
:::
