...
To connect your BuildMaster instance to ProGet you will need to generate an [API key](/docs/proget/reference-api/proget-apikeys?#creating-and-managing-api-keys) in ProGet first. 
...
![Edit Pipelines](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-edit.png){height="" width="50%"}

Scroll to the stages you wish to add requirements to and select "add". Then select "Edit Packages/Dependencies".

![Edit Packages](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-editpackages.png){height="" width="50%"}
...
![Checks](/resources/docs/buildmaster/deployment-continuous-delivery/buildmaster-pipelines-automatedchecks.png){height="" width="50%"}
