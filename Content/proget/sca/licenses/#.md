...
![Licensing Usage](/resources/docs/proget-licensing-summary.png){height="" width="50%"}
...
![](/resources/docs/proget-license-unknown-spdx.png){height="" width="50%"}
...
![](/resources/docs/proget-license-none.png){height="" width="50%"}
...
Exceptions can now be created by specifying Scope, Package name, and Version, and specifying exemption from License Rules. The "Package Name" field allows for wildcards (e.g. "Newton*"). The "Version" field allows for version ranges (E.g. "13.0.3").
...
![Edit License Type](/resources/docs/proget-licensing-edit-type.png){height="" width="50%"}
...
![Default licensing rule](/resources/docs/proget-licensing-default-rule.png){height="" width="50%"}
