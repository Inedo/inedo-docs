...
![License Usage](/resources/docs/proget-licenses-summary.png){height="" width="50%"}
...
![Edit Rules](/resources/docs/proget-policies-licenses-select.png){height="" width="50%"}
...
![Exceptions](/resources/docs/proget-licenses-exception-select.png){height="" width="50%"}
...
![Edit License](/resources/docs/proget-licenses-edit-type.png){height="" width="50%"}
...
![Default Rules](/resources/docs/proget-licenses-default-rule.png){height="" width="50%"}
