...
* Slack and teams messages are supported but more complicated (see [Connecting to Slack (archive.org)](https://web.archive.org/web/20230927142242/https://docs.inedo.com/docs/proget/administration/proget-notifications-webhooks/proget-notifiers-slack-integration))
