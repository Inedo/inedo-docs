...
* **Personal API Keys** use the associated user's privileges to determine what the key can do. These are based on [security task attributes](/proget-administration-security-creating-tasks), and are scoped in the same manner.
