...
The Asset Directory API provides simple RESTful access to files and folders in an asset directory. All HTTP requests are made through the following base URL:
