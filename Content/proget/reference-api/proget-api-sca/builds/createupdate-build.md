...
The *Create/Update Build* is an endpoint in [ProGet's SCA Directory API](/docs/proget/reference-api/proget-api-sca) that will create a new build or update properties on an existing build, and return a [ReleaseInfo Object](/docs/proget/reference-api/proget-api-sca#releaseinfo-object) object describing the new or updated release.
