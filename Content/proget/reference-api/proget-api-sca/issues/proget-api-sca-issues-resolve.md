...
:::(Info) (🚀 Quick Example: Setting an Issue Status to Resolved with Curl)
...
:::(Info) (🚧 Coming Soon 🚧)
The `sca issues resolve` command is coming soon. Similar to the HTTP Request, it will set the status of an issue to "Resolved".
:::
