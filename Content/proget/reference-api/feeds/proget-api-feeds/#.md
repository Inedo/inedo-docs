...
<h3 id="type-object">FeedStorageType Object Attributes</h3>

`FeedStorageType` is a JSON object (see [FeedStorageType.cs](https://github.com/Inedo/pgutil/blob/thousand/Inedo.ProGet/FeedStorageType.cs)) used as output for [List Feed Storage Types](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-storage-list).
