...
The Feeds Management API offer a simple mechanism for querying, creating, and updating [feeds](/docs/proget/feeds/feed-overview), and related data:
...
`RetentionRule` is a JSON object (see [RetentionRule.cs](https://github.com/Inedo/pgutil/blob/thousand/Inedo.ProGet/RetentionRule.cs)) that corresponds to the fields on a retention rule. It's used as input for [Update Feed](proget-api-feeds-update), and output for [Get Feed](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-get) and [List Feeds](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-list).
