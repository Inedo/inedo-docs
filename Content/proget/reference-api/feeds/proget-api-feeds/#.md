...
* [Get Feed Storage](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-create) - displays a feed's current storage information
* [Update Feed Storage](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-get) - updates a feed's storage options
* [List Feed Storage](/docs/proget/reference-api/feeds/proget-api-feeds/proget-api-feeds-list) - lists all available types of storage on a ProGet server
