...
*Create Feed* is available as both a `pgutil` command and an HTTP Request, and will create a feed, with the properties defined by a [ProgetFeed](/docs/proget/reference-api/feeds/proget-api-feedsi#feed-object) object in the body of the request.
...
The `feeds create` command set is used to create a feed.
