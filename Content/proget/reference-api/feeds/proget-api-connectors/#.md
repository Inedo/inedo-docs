...
The Connectors Management API offers a simple mechanism for querying, creating, and updating [connectors](/docs/proget/feeds/connector-overview), and related data:
...
* [List Connectors](proget-api-connectors-list) - describes all connectors, filtered as specified
* [Update Connector](proget-api-connectors-update) - updates a specified connector
* [Delete Connector](proget-api-connectors-delete) - deletes a specified connector
