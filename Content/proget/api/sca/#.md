...
[Create/Update Project](/docs/proget/api/sca/projects/proget-api-sca-projects-create) - Creates or updates a project
[Get Project](/docs/proget/api/sca/projects/proget-api-sca-projects-get) - Describes a specified project*
[List Projects](/docs/proget/api/sca/projects/proget-api-sca-projects-list) - Lists and describes specified projects

*\* Only available as an HTTP request.*

### 🚩 Issues { #issues-endpoints }

[List Issues](/docs/proget/api/sca/issues/proget-api-sca-issues-list) - Lists and describes specified issues
[Delete Issues](/docs/proget/api/sca/issues/proget-api-sca-issues-delete) - Deletes a specified issue
[Resolve Issue](/docs/proget/api/sca/issues/proget-api-sca-issues-resolve) - Sets a specified issue to resolved

### 💬 Comments { #comments-endpoints }

[Create/Update Comment](/docs/proget/api/sca/comments/proget-api-sca-comments-create) - Creates or updates a comment
[List Comments](/docs/proget/api/sca/comments/proget-api-sca-comments-list) - Lists and describes specified comments
[Delete Comment](/docs/proget/api/sca/comments/proget-api-sca-comments-delete) - Deletes a specified comment
...
[Export SBOM](/docs/proget/api/sca/sbom/proget-api-sca-sbom-export) - Exports a SBOM document from ProGet
[Import SBOM](/docs/proget/api/sca/sbom/proget-api-sca-sbom-import) - Imports a SBOM document to ProGet*
...
For example, to authenticate with the API key `abc12345` to [List Projects](/docs/proget/api/sca/projects/proget-api-sca-projects-list), you could specify the API key as follows:
...
`ProjectInfo` is a JSON object (see [ProjectInfo](https://github.com/Inedo/pgutil/blob/thousand/Inedo.ProGet/ProjectInfo.cs)) that correspond to the fields on a Project. It's used as both input and output data for [Create/Update Project](/docs/proget/api/sca/projects/proget-api-sca-projects-create) and output data for [List Projects](/docs/proget/api/sca/projects/proget-api-sca-projects-list).
...
`IssueInfo` is a set of key/value pairs that correspond to the fields on an Issue. It's used as output data for [List Issues](/docs/proget/api/sca/issues/proget-api-sca-issues-list), returning `IssueInfo` as a JSON-formatted object.
...
`BuildComment` is a JSON object (see [BuildComment](https://github.com/Inedo/pgutil/blob/thousand/Inedo.ProGet/BuildComment.cs)) that corresponds to the fields on a Comment. It's used as both input and output for [Create/Update Comment](/docs/proget/api/sca/comments/proget-api-sca-comments-create), and output for [List Comments](/docs/proget/api/sca/comments/proget-api-sca-comments-list).
