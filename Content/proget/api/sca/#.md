...
The Software Composition Analysis (SCA) API provides several `pgutil` commands (available as `pgutil builds`) and HTTP endpoints for querying, creating, and updating [builds](https://docs.inedo.com/docs/proget/sca/builds), [projects](https://docs.inedo.com/docs/proget/sca/builds), and related data:
