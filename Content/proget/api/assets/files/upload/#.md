...
A successful `201` response. A `402` response indicates a [missing, unknown, or unauthorized API Key](/docs/proget/api/security#authentication) and a `400` response indicates that the file already exists.
