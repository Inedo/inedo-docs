...
| Personal API Key | `View & Download Packages` is required for all endpoints<br/>`Manage Feed` is required for [Create Connector](/docs/proget/api/connectors/create)<br/>`Manage Feed` is required for [Delete Connector](/docs/proget/api/connectors/delete)
