...
| Feed API Keys | `View/Download` is required for all endpoints<br/>`Add/Repackage` is required for [Create/Upload Universal Package](/docs/proget/api/universal-feed/upload) |
| Personal API Key | `View & Download Packages` is required for all endpoints<br/>`Publish Packages` is required for [Create/Upload Universal Package](/docs/proget/api/universal-feed/upload) |
