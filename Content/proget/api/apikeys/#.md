...
To create or manage API keys, go to `Administration` > `API Keys & Access Logs`, and then select "create API key". You will be presented with a list of API keys and the ability to edit, delete, and create new ones.

![](/resources/docs/proget-api-keys-create.png){height="" width="50%"}
