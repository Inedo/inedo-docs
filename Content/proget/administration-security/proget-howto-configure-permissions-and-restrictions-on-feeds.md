...
[Feed Groups](https://docs.inedo.com/docs/proget/feeds/feed-overview#configuring-multiple-feeds) can help simplify permissions by grouping feeds that require the same permission or restriction rules.
