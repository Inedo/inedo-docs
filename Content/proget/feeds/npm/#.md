...
This command will publish `package.tgz` to your npm feed in ProGet. For a more detailed guide on creating and publishing your own npm packages you can read [HOWTO: Publish npm Packages to a Private Repository in ProGet](/docs/proget/feeds/npm/howto-npm-publish)
