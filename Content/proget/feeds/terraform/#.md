...
This setup allows you to use your ProGet registry as a private module source instead of the public [Hashicorp registry](https://registry.terraform.io/), ensuring controlled and consistent module usage. For more about creating and installing packages, see [HOWTO: Create and Upload Terraform Modules to ProGet](/docs/proget/feeds/terraform/howto-terraform-publish).
