...
![Create Feed](/resources/docs/proget-feeds-chocolateyselect.png){height="" width="50%"}
...
![Name Feed](/resources/docs/proget-chocolatey-internalized-namefeed.png){height="" width="50%"}
...
![Create Asset Directory](/resources/docs/proget-assets-create.png){height="" width="50%"}

You will then be prompted to name your asset directory, which we will call `chocolatey-assets` for this example. Selecting "Create Feed" will direct you to your new asset directory, currently empty. 
