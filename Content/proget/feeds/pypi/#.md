...
Setting your feed globally using `pip config` makes it a default source for all installations. To store your feed in the [`pip config`](https://pip.pypa.io/en/stable/topics/configuration/) file, you will need to use the [pip config](https://pip.pypa.io/en/stable/cli/pip_config/) command with a `--global` parameter containing your feed endpoint URL.
