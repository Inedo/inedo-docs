...
:::(Info)
Before migrating via drop path we recommend clearing your [Feed Connector cache](/docs/proget/feeds/connector-overview?#connector-caching). Otherwise, you'll import all of your cached packages.
:::
