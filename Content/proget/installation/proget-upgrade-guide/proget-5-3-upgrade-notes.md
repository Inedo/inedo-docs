...
Linux (i.e., Docker) installations may be upgraded by pulling the latest `inedo/proget` image and restarting the container, as per the [Linux Installation Guide](/support/documentation/proget/installation/installation-guide/linux-docker).

#### Rollback
See [restoring your ProGet instance](/support/documentation/proget/installation/installation-guide/linux-docker) for how to rollback.
