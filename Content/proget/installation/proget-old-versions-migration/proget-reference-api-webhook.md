...
For security and simplicity, these endpoints require that an [API Key](/https://docs.inedo.com/docs/proget/administration/security/api-keys) is created and passed into each request.
