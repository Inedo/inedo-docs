...
For Each Blocks in OtterScript allow you to repeat a group of statements for each item in a list.
They are essential for scenarios where you want to apply the same set of actions across multiple servers, files, or configuration values without duplicating code.
Basic Usage
