...
List variables are used much less frequently, primarily as the source of a [Loop Block](/v1/docs/executionengine/overview/statements-and-blocks/otter-execution-engine-statements-and-blocks-loop).
...
When you create a runtime variable with the [Set Variable Value](v1/docs/otter/execution-engine/statements-and-blocks/other-statements#set-variable) statement, that variable will be accessible in the current and nested blocks. For example:
